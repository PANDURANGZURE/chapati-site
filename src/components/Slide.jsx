...
export default function Slide() {
  ...
  return (
    <Link to="/order">
      <div
        ref={wrapperRef}
        className="relative w-full overflow-hidden bg-[#f7ecdf] cursor-none"
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
        onMouseMove={handleMouseMove}
      >
        <div className="flex whitespace-nowrap text-black text-5xl font-extrabold uppercase marquee bg-[#f7ecdf]">
        ...
        {showCursor && (
          <div
            ref={cursorRef}
            className="fixed top-0 left-0 z-50 pointer-events-none transform -translate-x-1/2 -translate-y-1/2"
          >
